                ...
                <div id="api-editor-display-data">
                    ...
                    <div class="collapse" id="collapseApiEditorSettings"
                        ...
                        <div class="border rounded mt-1 mb-3 shadow-sm p-3 bg-custom-gray" style="min-height: 53vh">
                            <form class="sendAjaxEditApiForm" action="#" method="post">
                                ...
                                <div class="row g-3 pt-2">
                                    <div class="col-xl-6 col-12">
                                        ...
                                        <input type="text" name="textarea_form_wrapper"
                                               value="<?=$opt->textarea_form_wrapper?>" placeholder="api-edit-wrapper"
                                               class="form-control" id="FormClass">
                                    </div>

                                    <div class="col-xl-6 col-12">
                                        <label for="InputTextAreaFormClass" class="form-label mb-1">Input Form Class</label>
                                        <input type="text" name="textarea_form_class"
                                               value="<?=$opt->textarea_form_class?>" placeholder="form-control w-100"
                                               class="form-control" id="InputTextAreaFormClass">
                                    </div>

                                    <div class="col-xl-6 col-12">
                                        <label for="TextAreaSubmitClass" class="form-label mb-1">Submit Button CSS</label>
                                    ...
                                    <div class="col-xl-6 col-12">
                                        <label for="TextAreaCancelClass" class="form-label mb-1">Cancel Button CSS</label>
                                ...
                                <div class="d-flex flex-wrap mt-4">
                                    <div class="form-check form-switch me-3">
                                        <input class="form-check-input" name="textarea_show_button" type="checkbox"
                                               role="switch" id="CheckShowButtonTextarea" <?=!$opt->textarea_show_button ?: 'checked'?>>
                                    ...
                                    <div class="form-check form-switch me-3">
                                        <input class="form-check-input" name="textarea_symbol" type="checkbox"
                                               role="switch" id="CheckShowSymbolTextarea" <?=!$opt->textarea_symbol ?: 'checked'?>>
                                        <label class="form-check-label"
                                               for="CheckShowSymbolTextarea"><?= __('Symbol anzeigen') ?></label>
                                    </div>
                                    <div class="form-check form-switch me-3">
                                        <input class="form-check-input" type="checkbox" name="textarea_label"
                                               role="switch" id="CheckShowTextareaLabel" <?=!$opt->textarea_label ?: 'checked'?>>
                                        <label class="form-check-label"
                                ...
                                <div class="row g-3 pt-2">
                                    <div class="col-xl-6 col-12">
                                        <label for="InputFormClassWrapper" class="form-label mb-1">Form Class</label>
                                        <input type="text" name="input_form_wrapper"
                                               value="<?=$opt->input_form_wrapper?>" placeholder="api-edit-wrapper"
                                    ...
                                    <div class="col-xl-6 col-12">
                                        <label for="InputSubmitClass" class="form-label mb-1">Submit Button CSS</label>
                                    ...
                                    <div class="col-xl-6 col-12">
                                        <label for="InputCancelClass" class="form-label mb-1">Cancel Button CSS</label>
                                ...
                                <div class="d-flex flex-wrap mt-4">
                                    ...
                                    <div class="form-check form-switch me-3">
                                        <input class="form-check-input" name="input_show_button" type="checkbox"
                                               role="switch" id="CheckShowButtonInput" <?=!$opt->input_show_button ?: 'checked'?>>
                                        <label class="form-check-label"
                                    ...
                                    <div class="form-check form-switch me-3">
                                        <input class="form-check-input" name="input_symbol" type="checkbox"
                                               role="switch" id="CheckShowSymbolInput" <?=!$opt->input_symbol ?: 'checked'?>>
                                        <label class="form-check-label"
                                    ...
                                    <div class="form-check form-switch me-3">
                                        <input class="form-check-input" type="checkbox"
                                               name="input_label"
                                               role="switch" id="CheckShowInputLabel" <?=!$opt->input_label ?: 'checked'?>>
                                        <label class="form-check-label"
                                ...
                                <div class="row g-3 py-2">
                                    <div class="col-xl-6 col-12">
                                        <label for="InlineFormClassWrapper" class="form-label mb-1">Form Class</label>
                                    ...
                                    <div class="col-xl-6 col-12">
                                        <label for="InlineFormClass" class="form-label mb-1">Input Form Class</label>
                                ...
                                <div class="form-check form-switch my-3">
                                    <input class="form-check-input" name="inline_symbol" type="checkbox"
                                           role="switch" id="CheckShowSymbolInline" <?=!$opt->inline_symbol ?: 'checked'?>>
                                    <label class="form-check-label"
                    ...
                    <div class="collapse" id="collapseApiEditorReset"
                        ...
                        <div class="border rounded mt-1 mb-3 shadow-sm p-3 bg-custom-gray" style="min-height: 53vh">
                            ...
                            <h4><i class="text-alert fa fa-exclamation-triangle"></i>&nbsp; <?=__('Reset all settings', 'hupa-api-editor')?>
                                   <small class="small d-block fw-normal mt-1">Diese Aktion lädt die <b class="text-alert strong-font-weight"> Default Settings</b> und kann <b class="text-alert strong-font-weight">nicht rückgängig</b> gemacht werden.</small>
                            </h4>
                            <hr>
                            <button data-type="reset_settings" class="btn-delete-section btn btn-danger"><i class="fa fa-exclamation-triangle"></i>&nbsp; <?=__('Reset all settings', 'hupa-api-editor')?></button>
                            </div>
                            <div class="api-reset-wrapper d-none">
                                <h5><i class="fa fa-info-circle font-blue"></i>&nbsp; Settings wurden zurückgesetzt
                                    <small class="small fw-normal text-muted d-block mb-3 mt-1">
                                        Nach dem zurücksetzen der Settings, muss die Seite <b>neu geladen</b> werden.</small> </h5>
                            <a href="<?=admin_url().'options-general.php?page=hupa-api-editor-options'?>" class="btn btn-blue-outline"><i class="fa fa-refresh fa-spin"></i>&nbsp; <?=__('Reload page', 'hupa-api-editor')?></a>
                            <hr>
                            </div>
                        </div>
                    </div>
