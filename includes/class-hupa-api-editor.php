...
class Hupa_Api_Editor {
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Hupa_Api_Editor_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Hupa_Api_Editor_Public( $this->get_plugin_name(), $this->get_version() );
